        ...
        describe ShippingCategoriesDuplicator do
          describe '#handle_clone_shipping_categories' do
            it 'duplicates unique source shipping categories and caches them' do
              ...
              shipping_categories_scope = instance_double('ActiveRecord::Relation')
              ...
              allow(Spree::ShippingCategory).to receive(:where).and_return(shipping_categories_scope)
              allow(shipping_categories_scope).to receive(:not).and_return(shipping_categories_scope)
              allow(shipping_categories_scope).to receive(:where).with(name: 'Physical Goods').and_return(shipping_categories_named_scope)
